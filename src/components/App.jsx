        ...
        {pConsultas.map((c,i)=>(
          <div key={c.id} style={{ display:"flex", gap:20, marginBottom:20 }}>
            ...
            <div style={{ flex:1, background:C.ivory, borderRadius:12, padding:"16px" }}>
              ...
              {c.queixa && <p style={{ fontSize:14, color:C.wine, margin:"0 0 6px", fontStyle:"italic" }}>"{c.queixa}"</p>}
...
function ConsultaForm({ initial={}, patients, onSave, onClose }) {
  const [f,setF] = useState({ registro:"",paciente_id:"",data:"",procedimentos:[],queixa:"",descricao:"",materiais:"",procedimentos_interesse:[],observacoes:"", ...initial });
  const set = k => e => setF(p=>({...p,[k]:e.target.value}));
  return (
    <div>
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:20 }}>
        ...
        <Field label="Queixa" span={2}><textarea style={gs.textarea} value={f.queixa} onChange={set("queixa")} /></Field>
